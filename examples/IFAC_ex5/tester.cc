...
std::vector<state_type> sys_post(const state_type &x, const input_type &u)
{
	...
	if(x[0] == 1 && u[0] == 1) {x_post1[0] = 4; ret.push_back(x_post1);}
	if(x[0] == 1 && u[0] == 2) {x_post1[0] = 4; ret.push_back(x_post1);}

	if(x[0] == 2 && u[0] == 1) {x_post1[0] = 5; ret.push_back(x_post1);}
	if(x[0] == 2 && u[0] == 2) {x_post1[0] = 4; x_post2[0] = 5; ret.push_back(x_post1); ret.push_back(x_post2);}

	if(x[0] == 3 && u[0] == 1) {x_post1[0] = 6; x_post2[0] = 7; ret.push_back(x_post1); ret.push_back(x_post2);}
	if(x[0] == 3 && u[0] == 2) {x_post1[0] = 5; ret.push_back(x_post1);}

	if(x[0] == 4 && u[0] == 1) {x_post1[0] = 4; ret.push_back(x_post1);}
	if(x[0] == 4 && u[0] == 2) {x_post1[0] = 4; ret.push_back(x_post1);}

	if(x[0] == 5 && u[0] == 1) {x_post1[0] = 4; ret.push_back(x_post1);}
	if(x[0] == 5 && u[0] == 2) {x_post1[0] = 4; ret.push_back(x_post1);}

	if(x[0] == 6 && u[0] == 1) {x_post1[0] = 5; ret.push_back(x_post1);}
	if(x[0] == 6 && u[0] == 2) {x_post1[0] = 5; ret.push_back(x_post1);}

	if(x[0] == 7 && u[0] == 1) {x_post1[0] = 6; ret.push_back(x_post1);}
	if(x[0] == 7 && u[0] == 2) {x_post1[0] = 6; ret.push_back(x_post1);}
	return ret;
}
...
{
	if(x[0] == 1 && u[0] == 1) { y[0] = 1; return; }
	if(x[0] == 1 && u[0] == 2) { y[0] = 1; return; }

	if(x[0] == 2 && u[0] == 1) { y[0] = 1; return; }
	if(x[0] == 2 && u[0] == 2) { y[0] = 1; return; }
	
	if(x[0] == 3 && u[0] == 1) { y[0] = 1; return; }
	if(x[0] == 3 && u[0] == 2) { y[0] = 1; return; }

	if(x[0] == 4 && u[0] == 1) { y[0] = 2; return; }
	if(x[0] == 4 && u[0] == 2) { y[0] = 2; return; }

	if(x[0] == 5 && u[0] == 1) { y[0] = 2; return; }
	if(x[0] == 5 && u[0] == 2) { y[0] = 2; return; }

	if(x[0] == 6 && u[0] == 1) { y[0] = 2; return; }
	if(x[0] == 6 && u[0] == 2) { y[0] = 2; return; }

	if(x[0] == 7 && u[0] == 1) { y[0] = 2; return; }
	if(x[0] == 7 && u[0] == 2) { y[0] = 2; return; }
}
...
int main() {
  ...
  double sslb[SS_DIM] ={1};
  double ssub[SS_DIM] ={7};
  double sseta[SS_DIM]={1};

  double islb[IS_DIM] ={1};
  double isub[IS_DIM] ={2};
  double iseta[IS_DIM]={1};

  double oslb[OS_DIM] ={1};
  double osub[OS_DIM] ={2};
